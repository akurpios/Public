function main(workbook: ExcelScript.Workbook) {
	...
	results.getColumnByName("Sender or Created by").getFilter().applyCustomFilter("<>*@domain.com>");
	results.getColumnByName("Recipients in To line").getFilter().applyCustomFilter("=*Author*");
